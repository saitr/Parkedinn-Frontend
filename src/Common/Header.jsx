...
function Header({ isAuthenticated }) {
  ...
  useEffect(() => {
    ...
    if (accessToken) {
      ...
      setIsSuperUser(false); // or setIsSuperUser(null) depending on your logic
    }
  }, []);
          ...
          {shouldDisplayLogout && (
            <>
              {isSuperUser ? (
                ...
                <li class="nav-item">
                {/* <a class="nav-link" href="/about"> About Us</a> */}
                <Link class="nav-link" to="/admin-signup">
                  Admin Signup
                </Link>
              </li>
              <li class="nav-item">
                {/* <a class="nav-link" href="/contact">Contact us</a> */}
                <Link class="nav-link" to="/staff-signup">
                  Staff Signup
                </Link>
              </li>
              </>
